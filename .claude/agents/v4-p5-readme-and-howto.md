# v4-p5-readme-and-howto: `docs/deepseek4-howto.md` for users

**Phase:** 5 — Validation against reference outputs
**Complexity:** S
**Branch:** `feat/v4-p5-readme-and-howto`
**Dependencies:** `v4-p5-eval-suite`

## Scope

Conversion + Metal-build + sample-run instructions. **Out:** marketing — this is engineering docs.
...
This spec was scaffolded by the v4-roadmap builder phase from row `v4-p5-readme-and-howto` of `docs/plans/v4-roadmap.md`. Re-read the roadmap before you start — the surrounding context (Metal gap analysis in §2, V4 delta in §3, risks in §5) is load-bearing.
